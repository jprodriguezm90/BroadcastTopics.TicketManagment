...
using BroadcastTopics.TicketManagement.Application.Exceptions;
using BroadcastTopics.TicketManagement.Domain.Entities;
using MediatR;

namespace BroadcastTopics.TicketManagement.Application.Features.Events.Commands.UpdateEvent
{
